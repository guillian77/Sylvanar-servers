			...
			<div class="contents-wrapper">
				...
				<div class="left-col" align="left">
					...
					*/
					...
					<p><a href="#" target="_blank" height="30%" with="100%"><img src="/images/slideshow_minecraft.png"></a>
					<p>Minecraft est un jeu de type « bac à sable » où le joueur est invité  à collecter un maximum ressources dans un monde de taille infinie afin de construire tout ce qu’il pourra pour survivre contre les monstres.
La nuit les monstres débarquent ! Assurez vous de profiter de vos journées ensoleillées pour vous construire un abri, une cabane, une mine, une forteresse ! En réalité n’importe quel type de construction capable de vous protéger des zombies, squelettes et autres monstres assoiffés de sang !
					<br/><br/>
					<hr/>
