		...
		<div class="content-top">
			<div class="content-bot">	
              ...
              ?>
						...
						<div class="featured-news">
						<p><font size="3">Sylvanar-servers</h1></font>
						<p><br/>Sylvanar est une équipe de joueurs visant le multi-gaming.<p>Nous souhaitons que les membres de notre équipe puissent se retrouver sur différents jeux et ainsi pouvoir jouer en équipe.<p><br/>Notre communauté dispose d'un serveur Teamspeak afin de communiqué au mieux sur les différents jeux.
						<p>N'attendez plus !
						<p><a href="/register.php">Rejoignez nous !</a>
						</div>
						<div id="news-updates">
							<?php
