...
<center>
<br>
<small>DEVELOPPE PAR DEKADMIN - AUFRERE GUILLIAN.<br /><?php echo $copyright['copyright']; ?> - <?php echo date('Y'); ?> <?php echo $website['title']; ?>.<br /><?php echo $copyright4['copyright4']; ?></small>
</center>
</div>
